...
namespace Nito.UniformResourceIdentifiers
{
    ...
    public sealed class HttpUniformResourceIdentifier : HttpUniformResourceIdentifierBase
    {
        ...
        public override IUniformResourceIdentifier Resolve(IUniformResourceIdentifierReference referenceUri) => Util.Resolve(this, referenceUri, Factory);
        ...
        {
            return new HttpUniformResourceIdentifierBuilder(uri).Build();
        }
    }
}
