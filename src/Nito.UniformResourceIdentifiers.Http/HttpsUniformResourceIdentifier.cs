...
namespace Nito.UniformResourceIdentifiers
{
    ...
    public sealed class HttpsUniformResourceIdentifier : ComparableBase<HttpsUniformResourceIdentifier>, IUniformResourceIdentifier
    {
        ...
        private static readonly Utility.DelegateFactory<HttpsUniformResourceIdentifier> Factory = (userInfo, host, port, pathSegments, query, fragment) =>
        ...
        /// <inheritdoc />
        public override string ToString() => Utility.ToString(HttpsScheme, ((IUniformResourceIdentifierReference) this).UserInfo, Host, Port, PathSegments, Query, Fragment);

        /// <summary>
        /// Resolves a relative URI against this URI.
        /// </summary>
        /// <param name="relativeUri">The relative URI to resolve.</param>
        public HttpsUniformResourceIdentifier Resolve(RelativeReference relativeUri) => Utility.Resolve(this, relativeUri, Factory);
